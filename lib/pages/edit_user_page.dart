            ...
            children: [
                      ...
                      children: [
                        img != null
                            ? CircleAvatar(
                                radius: 60,
                                backgroundImage:
                                    MemoryImage(img?.base64 as Uint8List),
                              )
                            : user.picture_id != 'n/a' &&
                                    user.picture_id != 'NotFound'
                                ? CircleAvatar(
                                    radius: 60,
                                    backgroundImage: NetworkImage(user
                                        .picture_id!), // Imagen de perfil actual
                                  )
                                : const CircleAvatar(
                                    radius: 60,
                                    backgroundImage: NetworkImage(
                                        'https://static.vecteezy.com/system/resources/thumbnails/009/292/244/small/default-avatar-icon-of-social-media-user-vector.jpg'), // Imagen de perfil por defecto
                                  ),
                        Positioned(
                            bottom: -10,
                            left: 80,
                              ...
                              ElevatedButton(
                                onPressed: () async {
                                  ...
                                  if (res != '') {
                                    ...
                                    await _graphQLEditUser.updateMe(
                                        userModel: user);
                                  } else {
              ...
              isEditingUser
                  ...
                  : Column(children: [
                      ...
                      ProfileInfoItem(
                          title: 'Nacionalidad', value: user.nationality),
                      ProfileInfoItem(
                          title: 'LinkedIn',
                          value: user.linkedin_link as String),
                      ProfileInfoItem(
                          title: 'Twitter', value: user.twitter_link as String),
                      ProfileInfoItem(
                          title: 'Facebook',
                          value: user.facebook_link as String),
                      ProfileInfoItem(
                          title: 'Pagina Web', value: user.web_site as String),
                    ]),
              const SizedBox(height: 10),
              const Divider(),
              const SizedBox(height: 10),
              ...
              ElevatedButton(
                onPressed: () {
                  setState(() {
                    isChangingPassword =
                        !isChangingPassword; // Toggle the value
                  });
                },
